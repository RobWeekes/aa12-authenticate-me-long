...
//       // Still dispatch with the data we have
...
//     const data = await response.json();
//     // console.log('User spots data received:', data);
...
//     }
//     case SET_USER_SPOTS: {
//       // Make sure we're setting an array and not overwriting with a single spot
//       const userSpotsArray = Array.isArray(action.payload) ? action.payload : [];
//       return {
//         ...state,
