...
//   // Handle successful review submission or deletion
//   const handleReviewSubmit = () => {
...
//               {/* Show delete button only if the review belongs to the current user */}
//               {sessionUser && (review.userId === sessionUser.id || review.User?.id === sessionUser.id) && (
      ...
      <div className="reviews-section">
        ...
        {showPostReviewButton && (
          <div className="post-review-button">
            <OpenModalButton
              buttonText="Post Your Review"
              modalComponent={<HowWasYourStayModal spotId={spotId} onReviewSubmit={handleReviewUpdate} />}
            />
          </div>
        )}
